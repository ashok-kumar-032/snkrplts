                ...
                <Col xl={3} lg={4} md={6} xs={12}>
                    <div className='related_box position-relative'data-aos="flip-left" data-aos-duration="3000">
                            <span className=''>
                                ...
                                <img className=' position-absolute new' src={new_1} alt="" />
                            </span>
                            <div className=' d-flex justify-content-between px-3 py-4'>
                                ...
                                <div className='mt-3'>
                                    <a href="#"><svg width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="48" height="48" fill="white" transform="translate(0.5 0.386963)"/>
            ...
            <div className=' d-flex justify-content-end mt-5 pt-2'>
                <a className='fw_600 fs_24 ff_Poppins clr_light_black d-inline-block back_box_1 effect' href="#">1</a>
                <a className='fw_600 fs_24 ff_Poppins clr_light_black d-inline-block back_box mx-2 effect' href="#">2</a>
                <a className='fw_600 fs_24 ff_Poppins clr_light_black d-inline-block back_box effect' href="#">3</a>
                <span><a className='mt-2 fw_400 fs_16 ff_Poppins clr_grey_1 d-inline-block next_box ms-3 effect' href="#">Next >></a>
</span>
            </div>
        </Container>
    </section>
